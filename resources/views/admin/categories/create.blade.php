...
<div class="container mt-4">
    <h2 class="text-pink fw-bold mb-3">➕ Thêm loại sản phẩm mới</h2>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white p-4 rounded-4 shadow-sm">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="CategoryName" class="form-control elegant-input" required value="{{ old('CategoryName') }}">
            @error('CategoryName')
